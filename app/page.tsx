...
import WelcomeScreen, { AnalysisOptions } from '@/components/WelcomeScreen';
import type { AnalysisResult } from '@/lib/analyzer';
import { analyzeKeywords } from '@/lib/analyzer';
...
export default function Home() {
  ...
  const handleWelcomeStart = (options: AnalysisOptions) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      // ✅ CLIENT-SIDE ANALYSIS (no API route needed)
      const analysis = await analyzeKeywords({
        keywords: keywordList,
        dataforseo: {
          login: apiKeys.dataForSeo.login,
          password: apiKeys.dataForSeo.password
        },
        ...
        onProgress: (current, total, keyword) => {
          setLoadingState({ current, total, keyword });
        }
      });
          ...
          <div className="p-8 space-y-10">
              ...
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-slate-400 leading-relaxed mb-3">
                    <strong className="text-teal-300">Login e Password DataForSEO</strong> per accedere ai dati di bidding.{' '}
                    <span className="text-teal-300">Salvati solo nel tuo browser</span>.{' '}
            ...
            <div className="bg-amber-900/20 border-2 border-amber-600/50 rounded-xl p-6 relative overflow-hidden">
              ...
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-slate-400 leading-relaxed mb-3">
                    <strong className="text-amber-300">API Key di Google Gemini</strong> per insights AI.{' '}
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 mb-3 leading-relaxed">
                Inserisci <strong>fino a 150 keyword</strong> (una per riga).
              </p>
              <textarea
                value={keywords}
